...
### 1.2 Problem and Goals <!--เหลือ Source Status -->

| Goal | Desired outcome | Source | Status |
|---|---|---|---|
| `G-01` | แสดงหมายเลขคิวและสถานะอาหารชัดเจน ลดการยืนรอแออัดหน้าเคาน์เตอร์ | `[F/E/TD]` | Fact / Decision / Assumption |
| `G-01` | ช่วยให้ร้านค้าจัดการคำสั่งซื้อได้เป็นระบบ ลดข้อผิดพลาดในการสื่อสารและการส่งมอบอาหาร | `[F/E/TD]` | Fact / Decision / Assumption |
| `G-01` | แสดงรายการคิวตามลำดับ FIFO ที่เข้าใจง่าย ช่วยให้พนักงานจัดลำดับงานหน้าเตาได้ถูกต้อง | `[F/E/TD]` | Fact / Decision / Assumption |

### 1.3 Product Scope <!--เหลือข้อ 3 -->

| In Scope | Out of Scope / Extension | Reason/source |
|---|---|---|
| การแสดงหมายเลขคิวและสถานะออเดอร์ Real-time ฝั่งลูกค้า (`FR-01`) | **ISSUE-01**: ระบบรับชำระเงินออนไลน์ (Payment Gateway) | ตัดออกตามคำแนะนำ Instructor เพื่อเน้น Queue Flow (Feedback W02) |
| หน้าจอควบคุมการจัดลำดับคิวตามเวลาสั่งซื้อ FIFO ฝั่งพนักงาน (`FR-04`) | **ISSUE-02**: ระบบแทรกคิวอัตโนมัติตามประเภทเมนู | พักไว้เนื่องจากขาดกฎเกณฑ์ความยุติธรรมที่แน่ชัดจากร้านค้า (E-04, Q-05) |
|  | ระบบจัดซื้อวัตถุดิบและระบบบัญชีหลังร้าน | เป็นระบบบริหารจัดการภายนอกขอบเขตการทำงานของร้านค้า |
...
|---|---|---|---|---|
| นักศึกษา / ลูกค้า | สั่งอาหาร ติดตามคิว รู้สถานะอาหาร | เปิดดูคิว, สั่งซื้อ, กดยกเลิกออเดอร์ (ก่อนเริ่มทำ) | ห้ามยกเลิกเมื่อสถานะเปลี่ยนเป็น `Cooking` | Stakeholder Map (W02) |
| พนักงานร้าน | จัดลำดับคิวและปรุงอาหารตามสั่ง | ดูตารางคิว FIFO, กดเปลี่ยนสถานะออเดอร์หน้าเตา | กดเปลี่ยนสถานะได้เฉพาะออเดอร์ในร้านตนเอง | Stakeholder Map (W02) |
| เจ้าของร้าน | ควบคุมนโยบายและป้องกันวัตถุดิบเสียหาย | กำหนดนโยบาย Cut-off time, กำกับดูแลภาพรวมร้าน | ปรับแก้เฉพาะข้อมูลร้านและกฎการยกเลิก | Stakeholder Map (W02) |
| ผู้ดูแลพื้นที่อาหาร | บริหารจัดการความแออัดส่วนกลาง | เรียกดูรายงานสถิติปริมาณคิวและความหนาแน่นรายชั่วโมง | เข้าถึงเฉพาะข้อมูลสถิติสรุปรวม ไม่เห็นข้อมูลส่วนตัวลูกค้า | Stakeholder Map (W02) |
